...
class Sugub(TimeStampedModel):
    user                    = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True,
                                                ...
                                                verbose_name='의뢰자')
    companyprofile          = models.ForeignKey('company_profile.CompanyProfile', on_delete=models.CASCADE, blank=True, null=True,
...
# 합격시킨 수급
class SugubSuccess(TimeStampedModel):
    sugub = models.ForeignKey(Sugub, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='합격채용의뢰서',
                              related_name='sugub_sugubsuccess')
    hrprofile = models.ForeignKey(HrProfile, on_delete=models.SET_NULL, blank=True, null=True, verbose_name='HR회사')
    sugub_title = models.CharField(max_length=50, blank=True, null=True, verbose_name='수급제목')
    chae_cd = models.CharField(max_length=100, null=True, blank=True, verbose_name='채용형태')
    sugub_jikjong = models.CharField(max_length=500, null=True, blank=True, verbose_name='직종')
    work_position = models.CharField(max_length=50, null=True, blank=True, verbose_name='포지션')
    work_role = models.TextField(max_length=5000, null=True, blank=True, verbose_name='담당업무')
    sugub_career_gb = models.CharField(max_length=50, null=True, blank=True, verbose_name='경력')
    education_cd = models.CharField(max_length=50, null=True, blank=True, verbose_name='학력')
    salary_gubun = models.CharField(max_length=50, null=True, blank=True, verbose_name='연봉')
    work_load_addr = models.CharField(max_length=100, null=True, blank=True, verbose_name='실근무지')
    spec = models.TextField(max_length=5000, null=True, blank=True, verbose_name='필수/우대사항')
    bokri = models.TextField(max_length=5000, null=True, blank=True, verbose_name='복리후생')

    class Meta:
        verbose_name_plural = ('2_4. 합격 채용의뢰서 / SugubSuccess')
