...
from .models import CompanyProfile, Sugub, JobAdvertise, JobApplicant, SugubReview, CompanyProfileCoWorker, JobQuestion, \
    JobAnswer, ImportPaymentHistory, Interview, Estimate, EstimateFile, SugubSign, SugubSuccess
...
@admin.register(SugubSuccess)
class SugubSuccessAdmin(admin.ModelAdmin):
    list_display = ['id', 'sugub', 'hrprofile', 'chae_cd', 'sugub_jikjong', 'work_position', 'work_role', 'sugub_career_gb',
                    'education_cd', 'salary_gubun', 'work_load_addr', 'spec', 'bokri']
