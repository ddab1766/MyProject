...
from backend.views import (
      ...
      SignUpCheckView, JikjongViewSet, GoogleLogin, QnaViewSet, FAQListView, ComCodeViewSet,
...
from company_profile.views import (
      SugubModelViewSet, SugubModelViewSet, JobAdViewSet, JobAppModelViewSet, CompanyProfileViewSet,
      SugubReviewViewSet, SugubReadOnlyViewSet, CompanyProfileCoWorkerViewSet, CompanyProfileReadOnlyViewSet,
      JobQuestionViewSet, JobAnswerViewSet, JobAdListViewSet, JobAdReadOnlyModelViewSet,
...
from user_profile.views import (
      ...
      EducationViewSet, NaverShortUrl, UserAdvKeyViewSet, CompanyAdvKeyViewSet, InterestAdvViewSet, UserSpecialListView,
      ResumeListView, UserProfileListView, ImportPaymentHistoryViewSet, LanguageViewSet, UserCommentViewSet,
      UserSpecialReadOnlyModelViewSet
)
from hr_profile.views import (
      HrProfileViewSet, HrProfileReadOnlyModelViewSet, HrSugubReadOnlyModelViewSet, HrSpecialReadOnlyViewSet, HrSpecialModelViewSet
)
...
router.register(r'importpayments', ImportPaymentHistoryViewSet, )
