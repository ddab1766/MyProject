...
class UserProfile(TimeStampedModel):
    user              = models.OneToOneField('backend.User', on_delete=models.CASCADE, related_name='userprofile')
    ...
    education_level   = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True, related_name='education_level',
    ...
    hope_site         = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True,
                                          limit_choices_to={'comidx':'BE', 'code_topcd':None}, verbose_name='희망근무지')
    address           = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True, related_name='address',
    ...
    recuser           = models.ForeignKey('backend.User', on_delete=models.CASCADE, default=None, blank=True,
                                          null=True, related_name='recuser', verbose_name='추천인')
    balance           = models.IntegerField(default=0, verbose_name='채공머니')
    status            = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True, related_name='status',
...
class UserSpecial(TimeStampedModel):
    user                    = models.ForeignKey('backend.User', on_delete=models.CASCADE, related_name='userspecial')
    jikjong_top             = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True,
                                                limit_choices_to={'comidx':'AA', 'code_topcd': None},
                                                verbose_name='직종코드(대)', related_name='userspecial_jikjong_top')
    jikjong_mid             = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, null=True, blank=True,
                                                limit_choices_to={'comidx': 'AA'},
                                                verbose_name='직종코드(중)', related_name="userspecial_jikjong_mid")
    jikjong_low             = models.ManyToManyField('backend.Comcode', blank=True, related_name="userspecial_jikjong_low", verbose_name='직종코드(소)',
    ...
    # except_company          = models.ManyToManyField('backend.Comcode', blank=True, related_name="except_company", verbose_name='제외기업')
...
class Resume(models.Model):
    ...
    resume_status           = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True, verbose_name='이력서 상태')
    ...
    except_company          = models.ManyToManyField('backend.Comcode', blank=True, verbose_name='이력서 제외기업',
...
class Language(models.Model):
    ...
    language        = models.ForeignKey('backend.Comcode', on_delete=models.CASCADE, blank=True, null=True, verbose_name='언어',
...
class UserAdvKey(models.Model):
    jobadvertise            = models.ForeignKey('company_profile.JobAdvertise', on_delete=models.CASCADE, blank=True, null=True, verbose_name='채용공고')
    user                    = models.ForeignKey('backend.User', on_delete=models.CASCADE, blank=True, null=True, verbose_name='사용자')
...
class InterestAdv(models.Model):
    jobadvertise            = models.ForeignKey('company_profile.JobAdvertise', on_delete=models.CASCADE, blank=True, null=True, verbose_name='채용공고')
    user                    = models.ForeignKey('backend.User', on_delete=models.CASCADE, blank=True, null=True,
...
class InterestSugub(models.Model):
    ...
    user = models.ForeignKey('backend.User', on_delete=models.CASCADE, blank=False, null=False,
...
class UserPoint(TimeStampedModel):
    user            = models.ForeignKey('backend.User', on_delete=models.CASCADE, blank=True, null=True, verbose_name='User',
                                        related_name='userpoint')
    poi_type        = models.ForeignKey('backend.Comcode', on_delete=models.SET_NULL, null=True, blank=True, verbose_name='포인트 종류',
...
class UserComment(TimeStampedModel):
    user            = models.ForeignKey('backend.User', on_delete=models.CASCADE, blank=True, null=True, verbose_name='유저', related_name='userComment_user')
    jobadvertise    = models.ForeignKey('company_profile.JobAdvertise', on_delete=models.CASCADE, blank=True, null=True, verbose_name='채용공고', related_name='userComment_jobad')
