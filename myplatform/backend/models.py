...
class Demand(models.Model):
    hrprofile = models.ForeignKey('hr_profile.HrProfile', on_delete=models.DO_NOTHING,
    ...
    paidup_user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='지불자', null=True, blank=True)
