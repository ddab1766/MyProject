...
from .models import (
    User, ComIdx, ComCode, Jikjong, CompanyBaseInfo, JikjongLow, ComPaCode, \
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('id', 'email', 'nickname', 'phone', 'is_admin', 'userprofile', 'is_active', 'is_temp', 'is_agree',
                    'is_privacy', 'profile_image', 'last_login' )
...
class DemandAdmin(admin.ModelAdmin):
    list_display = ['id', 'demand_ym', 'hrprofile', 'demand_amount', 'paidup_user', 'paidup_ymdt', 'paidup_yn', 'discount_ratio']
