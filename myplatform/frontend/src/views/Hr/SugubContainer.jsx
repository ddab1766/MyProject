            ...
            <div className="content">
                <Container>
                    {hr === null && company === null &&(
                        ...
                        />*/}
                        <InfoBox url={'/Hr/profileForm'} text={'자세한 채용의뢰서 확인을 위해 \'기업정보\'를 등록해야 합니다.'}/>
                        </>
                    )}
                    <Card>
                        <CardContent>
                            ...
                            <div>
                                ...
                                <Button className="btn-outline-info btn-round pt-1 pb-1" onClick={handleFilter}>{filterSet ? '필터닫기' : '필터열기'}</Button>
                            </div>
                            <hr/>
