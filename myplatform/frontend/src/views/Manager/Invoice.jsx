...
import {getFee} from "../../actions/employeeActions"
...
import RequestPay from "../../components/Etc/RequestPay";
        ...
        <FlexboxGrid justify="center">
            <FlexboxGrid.Item colspan={20}>
                <Panel style={{background:'white'}}>
                    ...
                    <RequestPay payinfo={{
                                    'amount': totalFee,
                                    'demand_ym': filter.created_time_max.split('-')[0] + filter.created_time_max.split('-')[1]
                    }}/>
                    ...
                    <TabPanel>
                        ...
                        <hr/>
                        <Paginations current={currentPage} postsPerPage={postsPerPage} totalPosts={fees.length} paginate={setCurrentPage}/>
                    </TabPanel>
                </Panel>
