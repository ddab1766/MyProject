...
import {Dropdown, Modal, Popover, Tag, TagGroup, Whisper, Button} from "rsuite";
import PopoverItem from "../../components/Rsuite/PopoverItem";
                                                ...
                                                <>
                                                    ...
                                                    >
                                                        {data.percentage < 70 ? (
                                                            ...
                                                            (<Button size="small" appearance="ghost" className="mr-1">수정</Button>)
                                                        }
                                                    </Link>
                                                </>
                                            )}
...
// }
                                                            ...
                                                            ><Button size="small" appearance="ghost" className="mr-1">리뷰작성</Button>
                                                            </Link>
                                                        )}
                                                </>
                                            )}
                                            <Link to={{pathname: '/Company/SugubDetailForm/', state: {sugub: data}}}>
                                                <Button size="small" appearance="default" className="mr-1">재등록</Button>
                                            </Link>
                                            {/*삭제*/}
                                            {data.sugub_status.code_id === 'CC0100000' &&
                                            <>
...
// sugub: data
                            ...
                            <Row>
                                <Col className="col-auto col-md-3">
                                    <small>
                                        <ShortTextOutlinedIcon style={{ color: '#7466ff', fontSize: 25}}/>
                                        {data.sugub_jikjong_top.code_name}
                                        <ChevronRightOutlinedIcon style={{ color: '#7466ff', fontSize: 25}}/>
                                        {data.sugub_jikjong_mid.code_name}
                                    </small>
                                </Col>
...
<Tag color="red" style={{fontSize:'12px'}}>{data.percentage} % </Tag>*/}
                    ...
                    <CardContent className="pb-2  row-content">
                        <Row>
                            <Col className="col-auto col-md-3">
                                <dl>
                                    <dt><ListAltOutlinedIcon style={{ color: '#7466ff', fontSize: 15}}/>{' '}경력</dt>
                            ...
                            <Col className="col-auto col-md-3">
                                <dl>
                                    <dt>
                                        <CreditCardOutlinedIcon style={{ color: '#7466ff', fontSize: 15}}/>
                                        {' '}급여({data.salary_gubun.code_name})
                                    </dt>
                                    <dd>
                            ...
                            <Col className="col-auto col-md-3">
                                <dl>
                                    <dt><SchoolOutlinedIcon style={{color: '#7466ff', fontSize: 15}}/>{' '}학력</dt>
                        ...
                        <div className="">
                            <dl>
                                <dt><BusinessOutlinedIcon style={{color: '#7466ff', fontSize: 15}}/>{' '}실근무지</dt>
                                <dd>{data.work_load_addr}</dd>
                            </dl>
                            <dl>
                                <dt><CheckOutlinedIcon style={{color: '#7466ff', fontSize: 15}}/>{' '}필수우대</dt>
                                <dd>{common.limitedText(data.spec)}</dd>
                            </dl>
                            <dl>
                                <dt><AssignmentOutlinedIcon style={{color: '#7466ff', fontSize: 15}}/>{' '}담당업무</dt>
