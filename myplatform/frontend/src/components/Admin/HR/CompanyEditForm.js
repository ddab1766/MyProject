...
const CompanyEditForm = (props) => {
    ...
    const handleImage = (data,field) => {
        ...
        console.log(field, data, data.name)
        axios
            .patch(apiUrls.HR_PROFILE + props.initialValues.id + '/', formValues, {
                headers: {
                    ...
                    <Col className="col-auto col-sm-3 col-md-3">
                        <Accordion className={classes.container} defaultExpanded>
                            ...
                            <AccordionDetails className="text-center">
                                <div className={classes.root}>
                                    {/*<ImageUpload handleImage={handleImage} image={props.history.location.state.comp.hrprofile_image[0].hr_image} company={props.history.location.state.comp.custname} field='company_image'/>*/}
                                    {/*<hr/>*/}
                                ...
                                <div className={classes.root}>
                                    ...
                                    <FormGroup row>
                                        <Field
                                            ...
                                            colSize={2}
                                        />
                                        <DaumPostcode formName="CompanyEditForm" filed1="load_addr" filed2='load_addr_code' filed3='load_addr_detail'/>
                                    </FormGroup>

                                    <Field name="load_addr" label="실근무지" component={renderField}
                                           type="text"
                                           labelSize={3}
                                           colSize={9}
                                    />
                                    <fieldset className="form-group">
                                        <Field name="load_addr_detail" label="나머지주소" component={renderField}
                                               type="text"
                                               labelSize={3}
                                               colSize={9}
                                        />
