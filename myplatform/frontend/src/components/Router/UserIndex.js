    ...
    <div>
      ...
      <Switch>
        <Suspense fallback={<LoaderSpinner />}>
          ...
          <Route
            path={`${match.url}/Recommend?type=:type`}
            component={RequireAuth(RecommendView)}
          />
          <Route path={`${match.url}/Recommend`} component={RecommendView} />
          <Route
            path={`${match.url}/Resume_edit/:resumeid`}
            component={RequireAuth(ResumeInfo)}
          />
          ...
          <Route
            path={`${match.url}/Resume?specialid=:specialid`}
            component={RequireAuth(ResumeView)}
          />
          <Route path={`${match.url}/Resume`} component={ResumeView} />

          <Route
            path={`${match.url}/List/:upid/:recuser`}
            component={ChaeInfo}
          />
          <Route exact path={`${match.url}/List/:upid`} component={ChaeInfo} />
          <Route exact path={`${match.url}/List`} component={ChaeListView} />
          <Route
            path={`${match.url}/special_edit/:specialid`}
            render={(props) => <UserSpecialEdit {...props} />}
          />
          {/*<Route path={`${match.url}/special_edit/:specialid`} component={RequireAuth(UserSpecialEdit)} />*/}
          <Route
            exact
            path={`${match.url}/special_edit/`}
            component={RequireAuth(UserSpecialEdit)}
          />
          <Route
            path={`${match.url}/Status?type=:type`}
          ...
          />
          <Route
            path={`${match.url}/reset_password_done`}
            component={PasswordResetDone}
          />
          <Route
            path={`${match.url}/reset/:uid/:token/`}
            component={PasswordResetConfirm}
          />
          <Route
            path={`${match.url}/profile`}
            component={RequireAuth(UserProfileView)}
          />
