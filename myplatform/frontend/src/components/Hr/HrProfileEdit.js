                    ...
                    <Card>
                        ...
                        <CardBody>
                            <TabPanel value={value} index={0}>
                                ...
                                <fieldset className="form-group">
                                    <Field name="load_addr" label="주소" component={renderInputField}
                                           type="text"
                                           size="lg"
                                           // labelSize={3}
                                           // colSize={9}
                                ...
                                <fieldset className="form-group">
                                    <Field name="load_addr_detail" label="상세주소" component={renderInputField}
                                           type="text"
                                           size="lg"
                                           // labelSize={3}
                                           // colSize={9}
                                ...
                                <Row>
                                    <Col md={6}>
                                        <fieldset className="form-group">
                                            <Field name="homepage" label="홈페이지" component={renderInputField}
                                                   type="text"
                                                   size="lg"
                                            />
                                        </fieldset>
                                    ...
                                    <Col md={6}>
                                        <fieldset className="form-group">
                                            <Field name="since" label="설립년도" component={renderInputField}
                                                   type="number"
                                                   size="lg"
                                            />
                                        </fieldset>
