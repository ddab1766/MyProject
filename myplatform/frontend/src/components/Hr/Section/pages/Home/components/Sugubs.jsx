...
import {Loader, Tag, TagGroup, Button, Modal} from "rsuite";
...
const Sugubs = (props) => {
    ...
    useEffect(()=>{
        setLoader(true)
        getSugub({conditions: 'all'}).then((data) => {
                ...
                {filteredList ? (
                    <>
                        {filteredList.length > 0 ? (
                            ...
                            <S.ItemList style={{justifyContent: 'center', width: '100%'}}>
...
export default connect(mapStateToProps)(Sugubs);
