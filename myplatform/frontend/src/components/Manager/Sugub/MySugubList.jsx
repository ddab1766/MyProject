...
import {Divider, Icon, Tag, TagGroup} from 'rsuite'
import {appliedStatusFilter, thousands} from "../../../function/common";
...
const MySugubList = (props) => {
    ...
    return  useObserver(()=>  (
        handleSetSugub(sugub.sugubs).length > 0 ? handleSetSugub(sugub.sugubs) : <Nothing text={'해당내역이 없습니다.'}/>
    ))
};
