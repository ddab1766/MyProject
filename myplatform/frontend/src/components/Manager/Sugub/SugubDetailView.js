...
import {getSugubDetail} from "../../../actions/sugubActions";
import * as common from "../../../function/common";
import SugubMenu from "./SugubMenu"
import {connect} from "react-redux";
import styled from "styled-components";
import {Dropdown, FlexboxGrid, Icon, Loader, Tag, TagGroup} from "rsuite";
                            ...
                            <div className="">
                                ...
                                <Row>
                                    <Col className="col-auto col-md-3">
                                        <dl>
                                            <dt>근무부서</dt>
                                            <dd>{sugub.work_dept ? sugub.work_dept : '-'}</dd>
                                        </dl>
                                        <dl>
                                            <dt>학력</dt>
                                ...
                                <Row>
                                    <Col className="col-auto col-md-3">
                                        <dl>
                                            <dt>급여</dt>
                                            <dd>{thousands(sugub.salary_start)} ~ {thousands(sugub.salary_end)}</dd>
                                        </dl>
                                        <dl>
                                            <dt>계약기간</dt>
                                ...
                                <Row>
                                    <Col className="col-md-6">
                                        ...
                                        <dl>
                                            <dt>본사주소</dt>
                                            <dd>
                                                {sugub.companyprofile.post_addr_code !== "null" ? '(' + sugub.companyprofile.post_addr_code + ')' : ''}
                                                {sugub.companyprofile.post_addr !== "null" ? sugub.companyprofile.post_addr : '-'}
                                                {sugub.companyprofile.post_addr_detail !== "null" ? sugub.companyprofile.post_addr_detail : ''}
                                            </dd>
                                        </dl>
                                    </Col>
                                    <Col className="col-md-6">
                                        ...
                                        <dl>
                                            <dt>홈페이지</dt>
                                            <dd>
                                                {sugub.companyprofile.homepage !== "null" ?
                                                    (
                                                        <a href={sugub.companyprofile && sugub.companyprofile.homepage !== null && sugub.companyprofile.homepage.indexOf('http') === -1 ?
                                                            `https://${sugub.companyprofile.homepage}` : `${sugub.companyprofile.homepage}`} target="_blank">{sugub.companyprofile.homepage}</a>
                                                    ) : '-'
                                                }
                                            </dd>
                                        </dl>
