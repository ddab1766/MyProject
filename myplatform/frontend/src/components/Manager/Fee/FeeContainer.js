...
import {Dropdown, FlexboxGrid, List, Popover, Whisper} from "rsuite";
                    ...
                    <List.Item key={item.id} index={index} style={{padding:0}}>
                        <FlexboxGrid justify="space-between">
                            ...
                            <FlexboxGrid.Item
                                ...
                                <div style={titleStyle}>{item.contract.companyprofile && item.contract.companyprofile.custname}</div>
                            </FlexboxGrid.Item>
{tabValue === 0 && <>
                            <FlexboxGrid.Item
                                colspan={2}
