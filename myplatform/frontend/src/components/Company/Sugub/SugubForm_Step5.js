...
import {renderInputField, renderInputNumberField, renderRadioField, renderCheckField} from "@/utils/renderUtils_rsuite";
import Slider from "@material-ui/core/Slider";
import {connect} from "react-redux";
import SugubValidate from "./SugubValidate";
import {renderNumberField} from "../../../utils/renderUtils";
                ...
                <CardBody>
                        ...
                        <Row>
                            <Col md="3" xs={4}>
                                <fieldset className="form-group">
                                    <Field name="age_start" component={renderInputNumberField}
                                           // type="number"
                                           required={true}
                                           value={ageRange[0]}
                                           onChange={(e, value)=>{
                            ...
                            <Col md="3" xs={4}>
                                <fieldset className="form-group">
                                    <Field name="age_end" component={renderInputNumberField}
                                           // type="number"
                                           value={ageRange[1]}
                                           onChange={(e, value)=>{
                        ...
                        <Row>
                            <Col md={12}>
                                <Field name="salary_gubun" component={renderRadioField}
                                       ...
                                       // code_topidx='AI'
                                       // code_topcd={null}
                                       options={comCode.filter(v=>v.code_topidx === 'AI' && v.code_topcd === null)}
                    ...
                    {salaryYear && (
                        <>
                                    ...
                                    <fieldset className="form-group">
                                        <Field name="salary_start" component={renderNumberField}
                                               ...
                                               onChange={(e, value)=>{
                                                   ...
                                                   let newValue = value;
                                                   if(typeof value === 'string') newValue = Number(value.replace(/,/gi, ''));
                                ...
                                <Col md="3">
                                    <fieldset className="form-group">
                                        <Field name="salary_end" component={renderNumberField}
                                               onChange={(e, value)=>{
                                                   let newValue = value;
                                                   if(typeof newValue === 'string') newValue = Number(newValue.replace(/,/gi, ''));
                            ...
                            <Field name="sugub_salary_adjust" component={renderCheckField}
