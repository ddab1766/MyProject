...
import {FlexboxGrid, Tag, TagGroup} from "rsuite";
                                ...
                                <Row>
                                    <Col className="col-auto col-md-6">
                                        ...
                                        <dl>
                                            <dt>본사주소</dt>
                                            <dd>
                                                {sugub.companyprofile.post_addr_code && sugub.companyprofile.post_addr_code !== "null" ? '(' + sugub.companyprofile.post_addr_code + ')' : ''}
