    ...
    return (
        <div>
            {isMobile ?
                <>
                    <div>
                        <Icon icon="check" style={{color:'#4caf50'}} size="lg"/><strong> 채용의뢰서 작성</strong>
                    </div>
                    <div>
                        <strong>2. 검토중</strong><br/> - 의뢰서를 수정하거나 추가정보를 입력해주세요.
                    </div>
                    <div>
                        <strong>3. 진행중</strong><br/> - 이력서 접수가 시작됩니다. 파트너사에서 인재를 접수하면, 지원자들을 검토해보세요.
                    </div>
                    <div>
                        <strong>4. 종료</strong><br/>  - 모든 프로세스가 완료되었습니다. 리뷰를 작성 해주세요.
                    </div>
                </>
                :
                <Steps>
