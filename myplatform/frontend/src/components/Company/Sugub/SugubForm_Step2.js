...
import {renderInputNumberField, renderSelectField} from "@/utils/renderUtils_rsuite";
                ...
                <CardBody>
                    ...
                    <fieldset className="form-group">
                        <Field name="chae_cd" component={renderRadioField}
                               // code_topidx='AC'
                               // code_topcd={null}
                               options={comCode.filter(v=>v.code_topidx === 'AC' && v.code_topcd === null)}
                    ...
                    {gigan && (
                        <>
                            ...
                            <fieldset className="form-group">
                                <Row>
                                    <Col sm={3} xs={4}>
                                        <Field name="chae_gigan" component={renderInputNumberField}
                                               size="lg"
                                               required={true}
                                        />
                                    </Col>
                                    <Col sm={5} xs={8}>
                                        <Field name="chae_gigan_type" component={renderSelectField}
                                               options={comCode.filter(v=> v.code_topidx ==='AE' && v.code_topcd === null)}
                        ...
                        <>
                            ...
                            <fieldset className="form-group">
                                <Field name="hire_type" component={renderRadioField}
                                       ...
                                       options={comCode.filter(v=>v.code_topidx === 'AD' && v.code_topcd === null)}
                                       // type="radio"
                                />
                            </fieldset>
                        </>
