...
import {fileViewerUrl, phoneFormat} from "../../function/common";
        ...
        return (<>
            <List.Item index={index} style={{backgroundColor: '#f2f6f9'}}>
                <FlexboxGrid>
                    ...
                    >
                        <Button appearance="primary" onClick={()=>history.push({
                                        ...
                                        {item.jobap.map((item, index) => (
                                            <List.Item key={item.id} index={index}>
                                                <FlexboxGrid justify="space-between">
                                                    ...
                                                    >
                                                        <Checkbox value={item.id} data-name={item.applied_username} />
                                                    </FlexboxGrid.Item>
