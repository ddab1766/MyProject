    ...
    return (
        <div className="content">
            <Container>
                <div className="title">
                    <h3>회사 정보를 등록해주세요<br/>
                        <small>HR회사 또는 헤드헌터(파트너사)에게 보여지게 됩니다.</small>
                    </h3>
                </div>
                <hr/>
                        ...
                        <CardBody>
                            <TabPanel value={value} index={0}>
                                ...
                                <Row>
                                    <Col md={6}>
                                        <fieldset className="form-group">
                                            <Field name="manager_email" label="담당자 이메일" component={renderInputField}
                                                   type="text"
                                                   size="lg"
                                                // required={true}
                                            />
                                    ...
                                    <Col md={6}>
                                        <fieldset className="form-group">
                                            <Field name="manager_phone" label="담당자 연락처" component={renderPhoneNumberField}
                                                   type="text"
                                                   size="lg"
                                                // required={true}
