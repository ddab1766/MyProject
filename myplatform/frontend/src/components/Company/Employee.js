...
import {dateFormat, thousands} from "../../function/common";
                                        ...
                                        <Col md={3}>
                                            <List dense>
                                                <ListItem>
                                                    ...
                                                    <ListItemText primary={v.employee.emp_name}
                                                                  secondary={v.employee.emp_phone}/>
                                                </ListItem>
                                            </List>
                                        </Col>
                                        <Col md={3}>
                                            <dl>
                                                <dt>계약기간</dt>
                                                <dd>
                                                    <strong>{v.contract_from && dateFormat(v.contract_from) + ' ~ ' + dateFormat(v.contract_to)} </strong>
                                                </dd>
                                            </dl>
                                            <dl>
                                                <dt>계약(개월)</dt>
                                            ...
                                            <dl>
                                                <dt>직접비</dt>
                                                <dd><strong>{thousands(v.direct_cost)} 원</strong></dd>
                                            </dl>
                                        </Col>
                                        <Col md={3}>
                                            <dl>
