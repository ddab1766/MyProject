                ...
                <Slider {...settings}>
                    <div style={{width: '280px'}}>
                        <S.ItemCard>
                            ...
                            <S.ItemCardFooter>
                                <S.Logo>
                                    <img src={ktmns} style={{display:"inline-flex"}}/>
                                </S.Logo>
                                <S.ItemDescription>
                    ...
                    <div style={{width: '280px'}}>
                        <S.ItemCard>
                            ...
                            <S.ItemCardFooter>
                                <S.Logo>
                                    <img src={pushnews} style={{display:"inline-flex"}}/>
                                </S.Logo>
                                <S.ItemDescription>
                        ...
                        <S.ItemCard>
                            <S.ItemCardBody>
                                ...
                                <S.ItemCardBodyText>
                                    ...
                                    원하던 플랫폼이 생겨 좋습니다!<br/>
                                    사용사업주 인사담당자들과 얼굴 붉히는 일이 줄어들었어요!
                                    <br/><br/><br/>
                                </S.ItemCardBodyText>
                            </S.ItemCardBody>
                            <S.ItemCardFooter>
