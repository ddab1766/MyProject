    ...
    return (
      <div>
        <S.Wrapper>
          ...
          <S.Title>채용마켓의 간편하고 신뢰할 수 있는 프로세스를 경험하세요.</S.Title>
          <S.ItemLabel>
            ...
            <div style={{ margin: "10px" }}>
              <S.ItemCard>
                ...
                <Row>
                  ...
                  <Col md={5}>
                    <br />
                    <img src={undraw_Wall_post_re_y78d} />
                  </Col>
                </Row>
              </S.ItemCard>
            </div>
            <div style={{ margin: "10px" }}>
              <S.ItemCard>
                ...
                <Row>
                  ...
                  <Col md={5}>
                    <br />
                    <img src={undraw_Credit_card_payment_re_o911} />
                  </Col>
                </Row>
              </S.ItemCard>
            </div>
                ...
                <Row>
                  <Col md={7}>
                    <S.ItemDescription>
                      ...
                      <br />
                      <small>
                        * 이력서를 WEB상에서 확인하거나 다운로드합니다.
                        <br />* 마음에 드는 구직자를 선택합니다.
                      </small>
                    </S.ItemDescription>
                  </Col>
                  <Col md={5}>
                    <br />
                    <img src={undraw_People_search_re_5rre} />
                  </Col>
                </Row>
              </S.ItemCard>
            </div>
