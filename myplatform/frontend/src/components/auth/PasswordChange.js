                ...
                <div className="row justify-content-center">
                    ...
                    >
                        ...
                        <fieldset className="form-group">
                            <Field name="password" label="기존 비밀번호" component={renderInputField}
                                   size="lg"
                        ...
                        <fieldset className="form-group">
                            <Field name="new_password1" label="새로운 비밀번호" component={renderInputField}
                                   size="lg"
                                   type="password" validate={[required({message: "필수 입력사항입니다."})]}
                            />
                        </fieldset>
                        ...
                        <fieldset className="form-group">
                            <Field name="new_password2" label="새로운 비밀번호 확인" component={renderInputField}
                                   size="lg"
                                   type="password" validate={[required({message: "필수 입력사항입니다."})]}
                            />
                        </fieldset>
